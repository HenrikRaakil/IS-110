...
public class SalesItemTest
{
    ...
    public void testTwoComment()
    {
        ...
        assertEquals(true, salesIte1.addComment("Java for idioter", "En bra bok", 5));
        assertEquals(2, salesIte1.getNumberOfComments());       // Denne sjekker hvor mange linjer
        // man kan endre tallet foran for å endre hvordan testen fungerer! Hva skjer hvis man endrer verdiene i linjene?
    }
